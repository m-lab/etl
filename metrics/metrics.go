...
var (
	...
	FileSizeHistogram = promauto.NewHistogramVec(
		prometheus.HistogramOpts{
			...
			Buckets: []float64{
				0,
				100, 139, 193, 268, 373, 518, 720,
				1000, 1389, 1931, 2683, 3728, 5179, 7197,
				10000, 13890, 19310, 26830, 37280, 51790, 71970,
				100000, 138900, 193100, 268300, 372800, 517900, 719700,
				1000000, 1389000, 1931000, 2683000, 3728000, 5179000, 7197000,
				10000000, 13890000, 19310000, 26830000, 37280000, 51790000, 71970000,
				100000000, 138900000, 193100000, 268300000, 372800000, 517900000, 719700000,
				1000000000, // 1 GB
				math.Inf(+1),
			},
		},
