...
func ndt_resultYaml() (*asset, error) {
	bytes, err := ndt_resultYamlBytes()
	if err != nil {
		return nil, err
	}
...
var _bindata = map[string]func() (*asset, error){
	"README.md":       readmeMd,
	"ndt_result.yaml": ndt_resultYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"ndt_result.yaml": &bintree{ndt_resultYaml, map[string]*bintree{}},
