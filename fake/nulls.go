...
func (n NullDateTime) String() string {
	...
	return bigquery.CivilDateTimeString(n.DateTime)
}
...
func (n NullTime) MarshalJSON() ([]byte, error) {
	...
	return []byte(`"` + bigquery.CivilTimeString(n.Time) + `"`), nil
}
...
func (n NullDateTime) MarshalJSON() ([]byte, error) {
	...
	return []byte(`"` + bigquery.CivilDateTimeString(n.DateTime) + `"`), nil
}
...
func nullableFieldType(t reflect.Type) bigquery.FieldType {
	switch t {
